...
import { NODE_DEFS } from "./nodes/nodeRegistry";
import { MergeNode, MathNode, DelayNode, ApiRequestNode, BooleanGateNode } from "./nodes/generatedNodes";
...
export const PipelineUI = () => {
    ...
    const getInitNodeData = (nodeID, type) => {
      ...
      if (type === "llm") {
        return { ...base, model: "gpt-4o-mini", temperature: 0.7 };
      }
      if (type === "text") {
